...
Below, trees for all phyla with at least `r treemin` representatives in the
...
colnames(enr.table) <- c("Gene significance", "Subsystem level",
  "Phylum", "Subsystem", "q-value")
