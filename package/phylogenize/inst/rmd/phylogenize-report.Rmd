...
pos.sig.count <- purrr::map_dbl(cirr_fam_abd_poms_mini$list_signif$pos.sig, length)

if ("neg.sig" %in% names(core[["list_signif"]])) {
    neg.sig.count <- purrr::map_dbl(cirr_fam_abd_poms_mini$list_signif$neg.sig, length)
