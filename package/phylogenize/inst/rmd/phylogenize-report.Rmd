...
if (is.null(signif_genes)) {
  pz.message("Skipping association summary because no association results were found")
} else {
  ...
  write.csv(
    file = file.path(pz.options('out_dir'), "pos-sig-thresholded.csv"),
    signif_genes[["pos.sig.descs"]]
  )
  if ("neg.sig" %in% names(signif_genes)) {
    write.csv(
      file = file.path(pz.options('out_dir'), "neg-sig-thresholded.csv"),
      signif_genes[["neg.sig.descs"]]
    )
  }
  write.csv(
    file = file.path(pz.options('out_dir'), "all-results.csv"),
...
if (is.null(signif_genes)) {
  pz.message("Skipping gene association heat maps because no association results were found")
} else {
