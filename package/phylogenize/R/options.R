...
#'   \item{core_method}{String. Which method to use to associate genes with phenotypes. Either "repermulize", "phylolm", "lm", or "POMS" (case insensitive). Default: "repermulize"}
