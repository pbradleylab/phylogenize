...
#'
#' \code{run.burst} runs, by default, the optimal sequence aligner vsearch
#' (doi.org/10.5281/zenodo.806850) on a FASTA file, typically one generated by
#' \code{prepare.vsearch.input}. By changing the \code{burst_bin}
...
#'
#' \code{sum.nonunique.burst} takes vsearch results and an abundance or
